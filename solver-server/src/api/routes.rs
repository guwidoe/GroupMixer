use super::handlers::{
    bootstrap_help_handler, create_job_handler, error_get_handler, error_list_handler,
    evaluate_input_handler, get_job_result_handler, get_job_status_handler,
    inspect_result_handler, operation_help_handler, recommend_settings_handler,
    schema_get_handler, schema_list_handler, solve_handler, validate_problem_handler, AppState,
};
use axum::{
    routing::{get, post},
    Router,
