...
This note defines the **target information architecture** for the Problem Setup flow and the component boundaries we want to preserve during the refactor.

## Goals

- reflect the real dependency structure of a problem definition
...
Problem Setup should become a grouped sidebar/drawer with these canonical groups and order:
...
Use a single route segment for the active Problem Setup section:
...
- extract a shared Problem Setup navigation schema/registry
...
- `navigation/problemSetupNavTypes.ts`
- `navigation/problemSetupNav.ts`
...
- `layout/ProblemSetupLayout.tsx`
- `layout/ProblemSetupSidebar.tsx`
- `layout/ProblemSetupMobileNav.tsx`

### Controller/orchestration layer

Owns store access, hooks, and section-level wiring:

- problem editor controller hook
...
- `ProblemEditor.tsx`
- `useProblemEditorController.ts`
- `ProblemSetupSectionRenderer.tsx`
