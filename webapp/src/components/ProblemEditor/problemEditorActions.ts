...
interface CreateProblemEditorActionsArgs {
...
export function createProblemEditorActions({ problem, updateProblem, constraints, entities }: CreateProblemEditorActionsArgs) {
  return {
