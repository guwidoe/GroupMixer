...
const CHROME = {
  expertWorkspaceLabel: '上級ワークスペース',
  faqHeading: 'よくある質問',
...
const USE_CASES_SECTION = {
  ...
  cards: [
    ...
    },
    {
      ...
      body: '1回分の分割にも、複数ラウンドのローテーションにも対応できます。',
    },
    {
      title: 'スピードネットワーキング',
...
const ADVANCED_SECTION = {
  ...
  cards: [
    {
      ...
      body: '友人、同僚、事前に決めたペアを常に同じグループにできます。',
    },
    {
      title: '特定の人を離す',
  ...
  buttonLabel: '上級ワークスペースを開く',
  supportingText:
    '上級ワークスペースでは、セッション、制約、ソルバー設定、詳細な結果分析まで細かく操作できます。',
};
...
const FAQS = {
  ...
  privacy: {
    ...
    answer:
      'はい。すべての処理はブラウザ内で行われ、名前やグループ情報がサーバーに送信されることはありません。',
  },
  constraints: {
    question: '一緒にしたい人・離したい人などのルールを追加できますか？',
    answer:
      'はい。詳細オプションで「同じグループにする」「一緒にしない」「複数セッション」「属性バランス」などを設定できます。より高度な制御は上級ワークスペースで行えます。',
  },
  multiSession: {
    question: '複数ラウンドのグループも作れますか？',
    answer:
      'はい。詳細オプションでセッション数を設定し、「繰り返しを避ける」を有効にすると、同じ人同士が何度も一緒になりにくくなります。',
  },
  workspace: {
    question: '上級ワークスペースとは何ですか？',
    answer:
      '上級ワークスペースでは、セッション、制約、ソルバー設定、過去結果の再利用、詳細分析まで同じ強力なエンジンで扱えます。',
  },
};
...
function createContent({
  ...
  return {
    ...
    optimizerCta: {
      ...
      title: '本格的なグループ最適化を試してください。',
      featureBullets: OPTIMIZER_FEATURES,
      buttonLabel: '上級ワークスペースを開く',
      supportingText: 'ランディングページで作成した下書きはそのまま引き継がれます。',
    },
    faqEntries,
    chrome: CHROME,
...
export const JA_TOOL_PAGE_CONTENT: Partial<Record<ToolPageKey, ToolPageLocalizedContent>> = {
  home: createContent({
    ...
    subhead: '名前を貼り付け、グループ数を選ぶだけですぐに分けられます。登録不要で、処理はブラウザ内のみです。',
    audienceSummary:
      'まずはシンプルなランダム分けから始め、必要なときだけバランス調整や制約、複数ラウンド最適化を追加できます。',
    faqEntries: [
      {
  ...
  'random-group-generator': createContent({
    ...
    description:
      '無料のランダムグループ作成ツール。名前リストを貼り付けて、グループ数を選ぶだけで即座に分割できます。授業、ワークショップ、イベントに最適です。',
    eyebrow: '素早いランダム分けに',
    heroTitle: 'ランダムグループ作成ツール',
    subhead:
      '名前リストを貼り付けて、必要なグループ数を選ぶだけ。登録不要、サーバー送信なしでブラウザ内だけで動作します。',
    audienceSummary:
      '授業活動、ワークショップ、イベント運営などで、すばやく手間なくグループ分けしたいときに最適です。',
    faqEntries: [
      {
        question: 'ランダムグループ作成ツールはどのように動きますか？',
        answer:
          '名前を1行ずつ貼り付け、グループ数またはグループサイズを指定して生成を押すと、すぐにバランスのよいランダム分けが作成されます。',
      },
      {
        question: 'グループ数やグループサイズは指定できますか？',
        answer:
          'はい。グループ数を固定することも、1グループあたりの人数を指定することもできます。',
      },
      FAQS.free,
      FAQS.privacy,
      FAQS.constraints,
    ...
    faqEntries: [
      {
        ...
        answer:
          '参加者名を貼り付け、チーム数を設定して生成を押してください。GroupMixer が即座にバランスよく分けます。',
      },
      {
        question: 'スキルや役割でチームを均等にできますか？',
        answer:
          'はい。CSV モードに切り替えて「役割」や「スキル」などの列を追加し、属性バランス機能を使えば均等に配分できます。',
      },
      FAQS.free,
      FAQS.privacy,
      FAQS.multiSession,
    ...
    faqEntries: [
      {
        ...
        answer:
          '参加者名を貼り付け、部屋数を選んで生成を押してください。すぐに各ルームへ割り当てられます。',
      },
      {
  ...
  'workshop-group-generator': createContent({
    ...
    subhead:
      'ワークショップのグループを数秒で作成。まずは簡単に、必要ならラウンドやバランス、制約を追加できます。',
    audienceSummary:
    ...
    faqEntries: [
      {
        ...
        answer:
          '参加者名を貼り付け、グループ数または人数を設定して生成を押してください。すぐに使えるグループが作成されます。',
      },
      {
    ...
    faqEntries: [
      {
        ...
        answer:
          '生徒名を1行ずつ貼り付け、グループ数を選んで生成を押してください。GroupMixer が自動で分けます。',
      },
      {
    ...
    faqEntries: [
      {
        ...
        answer:
          '参加者名を貼り付け、ラウンド数を設定して「繰り返しを避ける」を有効にすると、各ラウンドで重複を減らした組み合わせを作成します。',
      },
      {
        question: 'グループサイズは調整できますか？',
        answer:
          'はい。各ラウンドのグループ数または1グループの人数を指定できます。',
      },
      FAQS.free,
      FAQS.privacy,
      FAQS.workspace,
