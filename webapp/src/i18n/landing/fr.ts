...
const CHROME = {
  expertWorkspaceLabel: 'Espace expert',
...
const ADVANCED_SECTION = {
  ...
  supportingText:
    'L’espace expert donne un contrôle complet sur les sessions, les contraintes, la configuration du solveur et l’analyse détaillée.',
};
...
const FAQS = {
  ...
  constraints: {
    ...
    answer:
      'Oui. Ouvrez les options avancées pour ajouter des groupes à garder ensemble, des règles d’évitement, plusieurs sessions et l’équilibrage par attribut. Ou utilisez l’espace expert pour un contrôle complet.',
  },
  multiSession: {
  ...
  workspace: {
    question: 'Qu’est-ce que l’espace expert ?',
    answer:
      'L’espace expert offre un contrôle détaillé sur les sessions, les contraintes, la configuration du solveur, la réutilisation de résultats précédents et l’analyse complète. Il utilise le même moteur puissant.',
  },
};
