...
const FAQS = {
  ...
  privacy: {
    ...
    answer:
      'हाँ। सारी प्रोसेसिंग आपके ब्राउज़र में होती है। नाम और ग्रुप डेटा किसी सर्वर पर नहीं भेजा जाता।',
  },
  constraints: {
...
function createContent({
  ...
  return {
    ...
    optimizerCta: {
      ...
      title: 'पूरा ग्रुप ऑप्टिमाइज़र आज़माएँ।',
      featureBullets: OPTIMIZER_FEATURES,
      buttonLabel: 'एक्सपर्ट वर्कस्पेस खोलें',
      supportingText: 'लैंडिंग पेज वाला आपका ड्राफ्ट साथ लेकर जाता है।',
    },
    faqEntries,
    chrome: CHROME,
...
export const HI_TOOL_PAGE_CONTENT: Partial<Record<ToolPageKey, ToolPageLocalizedContent>> = {
  home: createContent({
    ...
    subhead: 'नाम पेस्ट करें, ग्रुप्स की संख्या चुनें और तुरंत जनरेट करें। निजी, तेज़ और बिना साइन-अप।',
    audienceSummary:
      'एक आसान रैंडम स्प्लिट से शुरू करें, और जब ज़रूरत हो तभी balancing, constraints और multi-round optimization जोड़ें।',
    faqEntries: [
      {
