...
impl PureSgpProblem {
    ...
    pub(super) fn position_id(&self, week: usize, group: usize, slot: usize) -> usize {
        ((week * self.num_groups) + group) * self.group_size + slot
    }

    pub(super) fn pair_key(&self, left: usize, right: usize) -> usize {
