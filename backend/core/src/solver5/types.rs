...
pub(super) enum ConstructionFamilyId {
    ...
    RtdQdmCatalog,
    MolrFromMols,
    ResolvableIncompleteTransversalDesign,
    MolrGroupFill,
    P4ResolvableBIBD,
    ResolvableBIBDCatalog,
...
impl ConstructionFamilyId {
    pub(super) fn label(self) -> &'static str {
        match self {
            ...
            Self::MolsCatalog => "mols_catalog",
            Self::MolsProduct => "mols_product",
            Self::RtdQdmCatalog => "rtd_qdm_catalog",
            Self::MolrFromMols => "molr_from_mols",
            Self::ResolvableIncompleteTransversalDesign => "ritd",
            Self::MolrGroupFill => "molr_group_fill",
            Self::P4ResolvableBIBD => "p4_router",
            Self::ResolvableBIBDCatalog => "rbibd_catalog",
