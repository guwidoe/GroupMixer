...
```text
backend/benchmarking/artifacts/runs/<run-id>/
backend/benchmarking/artifacts/baselines/<machine>/<suite>/<baseline>.json
backend/benchmarking/artifacts/comparisons/<suite>/...
```
...
```json
{
  ...
  "feature_name": null,
  "source": "gm-cli benchmark record",
  "git": {
    "branch": "main",
    "commit_sha": "...",
    "short_sha": "...",
  ...
  "suite_runs": [
    {
      ...
      "suite_manifest_path": "backend/benchmarking/suites/representative.yaml",
...
Recording and history operations are now available through `gm-cli`:

```bash
gm-cli benchmark record --suite representative
gm-cli benchmark record --suite hotpath-swap-preview
gm-cli benchmark record-bundle --suite representative --suite stretch --suite hotpath-search-iteration
gm-cli benchmark compare-prev --suite representative
gm-cli benchmark recordings list
gm-cli benchmark recordings show <recording-id>
gm-cli benchmark refs list
gm-cli benchmark refs show branches/main/suites/representative/full_solve/latest
...
```text
backend/benchmarking/artifacts/remotes/
  <machine-id>/
    artifacts/
