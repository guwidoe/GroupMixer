...
| `backend/benchmarking/cases/stretch/synthetic_partial_attendance_keep_apart_capacity_pressure_152p.json` | canonical dedicated stress benchmark | generated by `tools/benchmarking/generate_partial_attendance_keep_apart_case.py` from the deterministic planted-feasible partial-attendance builder | `objective_target.stretch.synthetic_partial_attendance_keep_apart_capacity_pressure_152p` | dedicated solver3 suites: `10s`, `1M`, plus 4-seed multiseed companions | keep-apart variant of the 152-person partial-attendance stress case; currently adds `24` `MustStayApart` windows for `301` total constraints | TODO |
| `backend/benchmarking/cases/stretch/kirkman_schoolgirls_15x5x7.json` | canonical dedicated classical benchmark | direct encoding of the classical Kirkman schoolgirl problem | `objective_target.stretch.kirkman_schoolgirls_zero_repeat_pairs` | case / dedicated suite: `max_iterations: 1500000`, `time_limit_seconds: 10` | TODO | TODO |
